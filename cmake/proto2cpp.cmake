function(RELATIVE_PROTOBUF_GENERATE_CPP SRCS HDRS ROOT_DIR)
  ...
  foreach(FIL ${ARGN})
    ...
    add_custom_command(
      ...
      ARGS --cpp_out  ${CMAKE_CURRENT_BINARY_DIR}  --grpc_out ${CMAKE_CURRENT_BINARY_DIR} -I ${ROOT_DIR} ${ABS_FIL} -I ${PROTOBUF_INCLUDE_DIR}
      --plugin=protoc-gen-grpc=${GRPC_CPP_PLUGIN}  -I ${ABS_FIL}
      DEPENDS ${ABS_FIL}
